                ...
                dbc.Col(
                    [
                        html.H1("Rose graph of Homicide Cases by Months", 
                                ...
                                style={'color':'#123456'}),
                        html.Hr(),
                        html.P("Show the frequency of homicide is regulated by season or month. By changing the drop-down menu, users can select the cases given specific relationship, weapon, crime type and state.", 
                                className="card-text",
